...
// ----------------------------------------------------------------------------
/** Link fix (identic pentru toti profesorii, nou sau existent) catre tutorialul video "cum
 * setez disponibilitatea/link-ul de recuperari" - afisat langa MakeupLinkButton mai jos.
 * Spre deosebire de makeup_calendar_link (per-profesor, editabil, stocat in profiles),
 * acesta e o singura constanta, nu vine din baza de date. */
const TUTORIAL_RECUPERARI_URL = 'https://youtu.be/g9qRKGI6V0o?si=XawLGDu5gmeSmgjf';
          ...
          <div>
            <div className="flex justify-between items-center mb-4 gap-3 flex-wrap">
              ...
              <div className="flex items-center gap-2 shrink-0">
                <a
                  href={TUTORIAL_RECUPERARI_URL} target="_blank" rel="noopener noreferrer"
                  title="Tutorial video: cum setezi disponibilitatea si link-ul de recuperari"
                  className="flex items-center gap-1.5 text-sm font-semibold text-gray-300 hover:text-[#C8F023] border border-gray-700 hover:border-[#C8F023]/50 rounded-2xl px-3 py-2 transition-colors shrink-0"
                >
                  <PlayCircle size={15} className="shrink-0" />
                  <span className="hidden sm:inline">Tutorial Recuperări</span>
                </a>
                <MakeupLinkButton
